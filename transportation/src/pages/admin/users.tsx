...
const UserRegistry = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (phone: string, record: any) => (
        <div className="flex flex-col gap-1">
          ...
          <div className="text-[10px] text-slate-500 lowercase italic">{record.email}</div>
        </div>
      )
    },
    
    {
      ...
      key: 'role',
      render: (role: string) => (
        <Tag color={role === 'driver' ? 'green' : 'blue'} className="font-black uppercase text-[10px] rounded-md px-3">
          {role}
        </Tag>
      )
    }
  ...
  return (
    <div className="space-y-6 h-screen">
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <QuickStat label="Passengers" value={data.stats.passenger} color="gold" />
